...
browser: ['Mimim Multi Device','Safari','1.0.0'],
auth: state})
//=================================================//
...
body: `FOLLOW INSTAGRAM @sampun_penak`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
mediaUrl: link,}}}
...
vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await haikal.getName(i + '@s.whatsapp.net')}\nFN:${await haikal.getName(i + '@s.whatsapp.net')}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET:mimimproject@gmail.com\nitem2.X-ABLabel:Email\nitem3.URL:https://https://www.instagram.com/sampun_penak/?hl=id\nitem3.X-ABLabel:Instagram\nitem4.ADR:;;Indonesia;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`})}
//=================================================//
